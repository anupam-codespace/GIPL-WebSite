...
const searchItems: SearchItem[] = [
  ...
  { title: "Patholab.Cloud", category: "Product", href: "/#products-showcase", desc: "Cloud laboratory information system automating clinical diagnostics, analyzer sync, and patient reporting" },
  { title: "TeamHub", category: "Product", href: "/#products-showcase", desc: "Enterprise HRMS with GPS biometric attendance, developer sprint tracking, and automated payroll" },
  { title: "Bungzo", category: "Product", href: "/#products-showcase", desc: "High-speed hyperlocal food delivery platform with real-time rider routing and order dispatch" },
  { title: "GlobizLibrary", category: "Product", href: "/#products-showcase", desc: "Digital academic repository and automated RFID cataloging system for universities and research hubs" },
  { title: "Enterprise IMS", category: "Product", href: "/#products-showcase", desc: "Multi-warehouse inventory OS with automated stock replenishment, batch tracking, and ERP sync" },
  { title: "Globizhub Listing", category: "Product", href: "https://listing.globizhub.com/", desc: "Global B2B trade marketplace and supplier directory connecting verified manufacturers with commercial buyers" },
