        ...
        >
          ...
          <div className="relative z-10 p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            ...
            <div className="max-w-2xl">
              {/* Category Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-[11px] font-mono font-bold text-amber-300 uppercase tracking-widest mb-4">
                <Sparkles className="w-3 h-3 text-amber-400" />
                <span>Allied Ventures &amp; Business Verticals · Vertical 05</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mb-14 sm:mb-20">
            <span className="text-xs font-mono font-bold uppercase tracking-widest text-[#1163FB] bg-blue-50 border border-blue-200/80 px-3.5 py-1.5 rounded-full inline-block mb-3">
              Export Craftsmanship &amp; Manufacturing
            </span>
                ...
                <div className="relative rounded-3xl overflow-hidden border border-slate-200/90 shadow-2xl bg-slate-100 aspect-[16/9] w-full">
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-5 text-white">
                    <span className="text-[10px] font-mono uppercase tracking-widest text-amber-300 font-bold block mb-0.5">
                      Bespoke Handcrafted Collection
                    </span>
                    <p className="text-sm sm:text-base font-bold">
                      Full-Grain Vegetable Tanned Travel Luggage &amp; Executive Briefcases
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6">
                <div className="relative rounded-3xl overflow-hidden border border-slate-200/90 shadow-2xl bg-slate-100 aspect-[16/9] w-full">
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-5 text-white">
                    ...
                    <p className="text-sm sm:text-base font-bold">
                      Precision-Stitched Wallets, Passport Covers, Brass-Buckled Belts &amp; Folios
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 order-1 lg:order-2">
                <div className="relative rounded-3xl overflow-hidden border border-slate-200/90 shadow-2xl bg-slate-100 aspect-[16/9] w-full">
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-5 text-white">
                    <span className="text-[10px] font-mono uppercase tracking-widest text-amber-300 font-bold block mb-0.5">
                      Artisan Craftsmanship Studio
                    </span>
                    <p className="text-sm sm:text-base font-bold">
                      Traditional Leathercraft Bench with Full-Grain Hides &amp; Hand-Finishing Tools
                    </p>
                  </div>
                </div>
              </div>
            ...
            {!submitted ? (
              <div>
                <span className="text-[11px] font-mono font-bold uppercase tracking-wider text-[#1163FB] bg-blue-50 px-3 py-1 rounded-full inline-block mb-2">
                  Leather Manufacturing Quotation
                </span>
